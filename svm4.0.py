...
# fw.close();
predictor1=sorted(predictor1.items(),key=operator.itemgetter(1))
predictor2=sorted(predictor2.items(),key=operator.itemgetter(1))
predictor3=sorted(predictor3.items(),key=operator.itemgetter(1))
predictor4=sorted(predictor4.items(),key=operator.itemgetter(1))
predictor5=sorted(predictor5.items(),key=operator.itemgetter(1))
predictor6=sorted(predictor6.items(),key=operator.itemgetter(1))
predictor7=sorted(predictor7.items(),key=operator.itemgetter(1))

print(predictor1,Y[7000])
print(predictor2,Y[6000])
print(predictor3,Y[5000])
print(predictor4,Y[3000])
print(predictor5,Y[2000])
print(predictor6,Y[1000])
print(predictor7,Y[0])
